...
void DNSUpdater::checkPublicIP()
{
    ...
    DownloadManager::instance()->download(
            DownloadRequest(u"http://checkip.dyndns.org"_s).userAgent(QStringLiteral("Transmission/1.32+"))
...
void DNSUpdater::updateDNSService()
{
    ...
    m_lastIPCheckTime = QDateTime::currentDateTime();
    DownloadManager::instance()->download(
            DownloadRequest(getUpdateUrl()).userAgent(QStringLiteral("Transmission/1.32+"))
